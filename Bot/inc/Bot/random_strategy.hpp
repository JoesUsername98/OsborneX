...
public:
    ...
    /// Feeds the latest observed top-of-book so subsequent random orders are
    /// priced around the live market instead of always falling back to
    /// options.default_price. Safe to call from any thread (e.g. a
...
private:
    ...
    std::optional<Simulation::TopOfBookUpdate> last_known_top_;
